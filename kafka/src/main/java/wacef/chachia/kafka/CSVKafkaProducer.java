...
public class CSVKafkaProducer {
    ...
    private static String KafkaTopic = "waceftopic";
    private static String CsvFile = "test_data.csv";
    ...
    private void PublishMessages() throws URISyntaxException {
        ...
        try {
            ...
            try (Stream<String> FileStream = Files.lines(Paths.get(uri))) {
